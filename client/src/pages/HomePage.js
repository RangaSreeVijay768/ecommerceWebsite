...
import CreateCategory from "./admin/create_category";
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="card-name-price">
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                const isInCart = cart.some(item => item._id === p._id); // Check if product is already in cart
                                                if (isInCart) {
                                        ...
                                        >
                                            {cart.some(item => item._id === p._id) ? "GO TO CART" : "ADD TO CART"}
                                        </button>
                                    </div>
                                </div>
                            </div>
